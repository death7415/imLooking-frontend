...
export const API_ENDPOINTS = {
  ...
  auth: {
    ...
    loginOtpStart: `${AUTH_BASE_PATH}/login/otp/start`,
    loginOtpComplete: `${AUTH_BASE_PATH}/login/otp/complete`,
    logout: `${AUTH_BASE_PATH}/logout`,
    refresh: `${AUTH_BASE_PATH}/refresh`,
    signup: `${AUTH_BASE_PATH}/signup`,
    signupAvailability: `${AUTH_BASE_PATH}/signup/availability`,
    startVerification: `${AUTH_BASE_PATH}/verification/start`,
    completeVerification: `${AUTH_BASE_PATH}/verification/complete`,
    emailVerificationStart: `${AUTH_BASE_PATH}/email-verification/start`,
    emailVerificationStatus: `${AUTH_BASE_PATH}/email-verification/status`,
